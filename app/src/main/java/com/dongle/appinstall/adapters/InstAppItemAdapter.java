...
public class InstAppItemAdapter extends RecyclerView.Adapter<InstAppItemAdapter.AppItemHolder> {
    private final List<PackageInfo> list;
    private final PackageManager packageManager;
    private final List<String> pathNewList;
    private SelectedItem listener;
    private boolean isSelect;

    public InstAppItemAdapter(PackageManager packageManager, List<String> pathNewList, List<PackageInfo> list) {
        this.list = list;
        this.pathNewList = pathNewList;
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull InstAppItemAdapter.AppItemHolder holder, int position) {
...
//        String packageName = packageInfo.packageName;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                listener.onSelected(holder.checkBox, pathNewList.get(position), position);
            }
        });
    }
    ...
    public interface SelectedItem {
        void onSelected(CheckBox checkBox, String packagePath, int position);
    }
    ...
    public class AppItemHolder extends RecyclerView.ViewHolder {
        ...
        public AppItemHolder(@NonNull @NotNull View itemView) {
            super(itemView);
